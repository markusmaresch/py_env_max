...
pip check
pip install autograd==1.4 autopep8==1.7.0 babel==2.10.3 beautifulsoup4==4.11.1 biopython==1.79 bleach==5.0.1 blessed==1.19.1 blessings==1.7
pip check
pip install blis==0.7.8 bottleneck==1.3.5 categorical-distance==1.9 cattrs==22.1.0 cffi==1.15.1 cftime==1.6.2 click==8.1.3 clikit==0.6.2
pip check
...
pip check
pip install axial-positional-embedding==0.2.1 azure-core==1.25.1 black==22.8.0 bokeh==2.4.3 botocore==1.27.79 branca==0.5.0 brotlipy==0.7.0 bs4==0.0.1
pip check
pip install build==0.8.0 cachecontrol==0.12.12 chart-studio==1.1.0 click-didyoumean==0.3.0 click-plugins==1.1.1 click-repl==0.2.0 cligj==0.7.2 coinpaprika==0.1.0
pip check
pip install colorcet==3.0.0 coloredlogs==15.0.1 confection==0.0.2 coremltools==6.0 croniter==1.3.7 cryptography==38.0.1 cssselect2==0.7.0 curtsies==0.4.0
pip check
