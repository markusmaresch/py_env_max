...
pip check
pip install "cachetools>=6.2.6"
pip install "certifi>=2026.2.25"
pip install "chardet>=7.2.0"
pip install "charset-normalizer>=3.4.6"
...
pip install "greenlet>=3.3.2"
pip install "griffelib>=2.0.0"
pip check
...
pip install "jsonpath-python>=1.1.5"
pip install "jsonpointer>=3.1.0"
...
pip install "librt>=0.8.1"
pip install "llvmlite>=0.46.0"
pip install "lmdb>=2.1.1"
...
pip install "openinference-semantic-conventions>=0.1.28"
pip install "opentelemetry-util-http>=0.59b0"
pip install "opt-einsum>=3.4.0"
pip install "optype>=0.17.0"
...
pip install "parso>=0.8.6"
pip install "pathspec>=1.0.4"
pip install "peewee>=4.0.2"
...
pip check
pip install "types-python-dateutil>=2.9.0.20260323"
...
pip check
pip install "yoctopuce>=2.1.12413"
...
pip install "google-resumable-media>=2.8.0"
pip install "googleapis-common-protos>=1.73.0"
pip install "griffecli>=2.0.0"
...
pip check
pip install "jaraco-functools>=4.4.0"
...
pip install "numpy-typing-compat>=20251206.2.4"
pip check
...
pip install "opentelemetry-proto>=1.38.0"
pip check
pip install "pdf2image>=1.17.0"
pip install "pipdeptree>=2.30.0"
pip install "plyfile>=1.1.3"
pip install "portalocker>=3.2.0"
pip install "prompt-toolkit>=3.0.52"
pip install "proto-plus>=1.27.1"
...
pip install "scipy-stubs>=1.17.1.3"
...
pip install "urllib3-future>=2.17.903"
pip check
...
pip check
pip install "kfp-server-api>=2.14.6"
...
pip check
pip install "google-api-python-client>=2.185.0"
pip install "google-cloud-appengine-logging>=1.7.0"
pip install "google-cloud-artifact-registry>=1.17.0"
pip install "google-cloud-compute>=1.40.0"
...
pip check
pip install "google-cloud-aiplatform>=1.121.0"
pip install "kfp>=2.14.6"
pip check
pip install "langchain-classic>=1.0.0"
pip install "langgraph-prebuilt>=1.0.0"
pip install "llama-cloud-services>=0.6.54"
pip install "llama-index-embeddings-openai>=0.5.1"
pip install "llama-index-indices-managed-llama-cloud>=0.9.4"
pip install "llama-index-llms-ollama>=0.8.0"
pip install "llama-index-llms-openai>=0.6.5"
pip install "llama-index-readers-file>=0.5.4"
pip install "llm-anthropic>=0.20"
...
pip install "openinference-instrumentation-llama-index>=4.3.7"
pip install "openinference-instrumentation-openai>=0.1.39"
pip install "opentelemetry-exporter-gcp-trace>=1.10.0"
pip install "opentelemetry-exporter-otlp>=1.38.0"
pip install "opentelemetry-instrumentation-fastapi>=0.59b0"
pip check
pip install "pandas-gbq>=0.29.2"
pip install "sqlalchemy-spanner>=1.17.0"
pip check
rem Level 7
rem Level 8
pip install "google-cloud-pipeline-components>=2.21.0"
pip check
pip install "jupyter-server>=2.17.0"
pip install "langchain-community>=0.4"
pip install "langgraph>=1.0.0"
pip install "llama-index-cli>=0.5.3"
pip install "llama-index-multi-modal-llms-openai>=0.6.2"
pip install "llama-parse>=0.6.54"
...
pip install "llama-index-readers-llama-parse>=0.5.1"
pip check
