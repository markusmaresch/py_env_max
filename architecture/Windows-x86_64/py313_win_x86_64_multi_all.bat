rem 2025-10-19T21:19:44.101382+00:00
rem Level 1
...
pip check
pip install "kfp-pipeline-spec>=2.14.6"
...
pip install "openmeteo-sdk>=1.21.2"
...
pip install "tifffile>=2025.10.16"
...
pip install "urllib3-future>=2.14.905"
pip check
