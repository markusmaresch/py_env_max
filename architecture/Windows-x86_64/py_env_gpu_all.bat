...
pip install "stringzilla>=3.11.3"
...
pip install "marshmallow>=3.26.0"
...
pip install "tifffile>=2025.1.10"
...
pip install "grpc-google-iam-v1>=0.14.0"
...
pip install "google-cloud-secret-manager>=2.22.1"
...
pip check
pip install "google-cloud-bigquery>=3.29.0"
...
pip install "openinference-instrumentation-llama-index>=3.1.3"
...
rem Level 7
rem Level 8
pip install "google-cloud-pipeline-components>=2.18.0"
pip check
