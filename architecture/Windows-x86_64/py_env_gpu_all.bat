...
pip install "condense-json>=0.1.2"
...
pip install "openinference-semantic-conventions>=0.1.17"
...
pip install "pycodestyle>=2.13.0"
...
pip install "yoctopuce>=2.1.5971"
pip check
...
pip install "openmeteo-sdk>=1.20.0"
...
pip install "google-auth>=2.40.0"
...
pip check
pip install "intel-cmplr-lib-ur>=2025.1.1"
...
pip install "google-genai>=1.2.0"
pip check
...
pip install "google-cloud-compute>=1.30.0"
pip install "google-cloud-core>=2.4.3"
pip install "google-cloud-resource-manager>=1.14.2"
pip install "google-cloud-secret-manager>=2.23.3"
...
pip install "llm>=0.25"
pip check
pip install "nbclient>=0.10.2"
pip install "openinference-instrumentation>=0.1.28"
...
pip check
pip install "google-cloud-aiplatform>=1.91.0"
pip install "kfp>=2.10.1"
pip check
pip install "langchain>=0.1.20"
pip install "llama-index-program-openai>=0.2.0"
pip install "llama-index-readers-llama-parse>=0.3.0"
pip install "llm-anthropic>=0.15.1"
pip install "llm-gemini>=0.18.1"
pip install "llm-ollama>=0.9.1"
pip check
pip install "nbconvert>=7.16.6"
pip install "openinference-instrumentation-langchain>=0.1.42"
pip install "openinference-instrumentation-llama-index>=4.2.1"
pip install "openinference-instrumentation-openai>=0.1.27"
...
rem Level 7
rem Level 8
pip install "google-cloud-pipeline-components>=2.20.0"
pip check
