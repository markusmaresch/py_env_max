...
pip check
pip install "fastjsonschema>=2.21.0"
...
pip install "stringzilla>=3.10.10"
pip check
...
pip check
pip install "google-api-core>=2.23.0"
pip install "google-auth-httplib2>=0.2.0"
pip install "google-auth-oauthlib>=1.2.1"
pip check
pip install "intel-openmp>=2025.0.2"
