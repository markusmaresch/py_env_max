...
pip install "cloudpathlib>=0.19.0"
...
pip install "intel-cmplr-lib-ur>=2024.2.1"
...
pip install "openinference-semantic-conventions>=0.1.10"
...
pip install "toga-core>=0.4.7"
pip install "tqdm>=4.66.5"
pip install "typeguard>=4.3.0"
...
pip install "strawberry-graphql>=0.246.2"
pip check
...
pip install "arize-phoenix-evals>=0.17.0"
pip check
...
pip install "google-cloud-resource-manager>=1.12.5"
