...
pip install "openinference-semantic-conventions>=0.1.23"
...
pip install "nvidia-cufft-cu12>=11.3.3.83"
pip install "nvidia-cusparse-cu12>=12.5.8.93"
pip check
...
pip install "tifffile>=2025.10.4"
