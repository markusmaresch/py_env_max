...
pip install "google-resumable-media>=2.10.0"
pip install "googleapis-common-protos>=1.75.0"
pip install "griffecli>=2.1.0"
pip install "grpcio>=1.83.0"
pip check
...
pip check
pip install "langchain-protocol>=0.0.18"
pip install "lazy-loader>=0.5"
...
pip install "openmeteo-sdk>=1.27.2"
pip install "opentelemetry-api>=1.44.0"
pip install "opentelemetry-proto>=1.44.0"
pip check
pip install "pandas-stubs>=3.0.3.260530"
pip install "pexpect>=4.9.0"
pip install "pillow-heif>=1.5.0"
pip install "plyfile>=1.1.4"
pip install "prompt-toolkit>=3.0.53"
pip install "proto-plus>=1.28.2"
...
pip check
pip install "readme-renderer>=45.0"
pip install "referencing>=0.37.0"
pip install "reportlab>=5.0.0"
...
pip check
pip install "gitpython>=3.1.57"
pip install "griffe>=2.1.0"
pip install "grpc-google-iam-v1>=0.14.4"
pip install "grpcio-status>=1.83.0"
pip check
pip install "httpx>=0.28.1"
pip install "hydra-core>=1.3.4"
pip check
pip install "inflect>=7.5.0"
pip install "intel-cmplr-lib-ur>=2026.1.0"
pip install "ipython>=9.15.0"
pip check
pip install "jaxlib>=0.11.0"
pip install "jsonschema-specifications>=2025.9.1"
pip install "jupyter-builder>=1.1.1"
...
pip install "sqlite-utils>=4.1.1"
...
pip check
pip install "banks>=2.4.5"
pip install "braincube-connector>=2.8.0"
pip check
pip install "curl-cffi>=0.15.0"
pip install "db-dtypes>=1.7.1"
pip check
pip install "fastapi>=0.140.7"
pip install "google-auth>=2.56.2"
pip check
pip install "huggingface-hub>=1.25.1"
pip install "intel-openmp>=2026.1.0"
...
pip install "google-cloud-compute>=1.50.0"
pip install "google-cloud-core>=2.6.0"
...
pip install "langgraph-checkpoint>=4.1.1"
pip install "langgraph-sdk>=0.4.2"
pip install "llama-index-core>=0.12.52.post1"
pip install "llm-anthropic>=0.25.1"
pip install "llm-gemini>=0.32"
pip install "llm-ollama>=0.16.1"
pip check
...
pip install "streamlit>=1.60.0"
pip check
pip install "timm>=1.0.28"
pip install "transformers>=5.14.1"
pip install "twine>=7.0.0"
pip check
# Level 6
# Level 7
pip install "google-cloud-bigquery>=3.42.2"
pip install "google-cloud-storage>=3.13.0"
pip check
...
# Level 7
# Level 8
pip install "google-cloud-aiplatform>=1.162.0"
pip check
pip install "jupyter-server>=2.20.0"
...
pip install "llama-parse>=0.6.34"
pip check
pip install "pandas-gbq>=0.35.0"
pip check
# Level 8
# Level 9
pip install "jupyter-lsp>=2.3.1"
pip install "jupyterlab-server>=2.28.0"
pip check
