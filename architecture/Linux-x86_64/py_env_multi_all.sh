...
pip check
pip install "kfp-pipeline-spec>=0.6.0"
pip install "lazy-loader>=0.4"
pip install "lightning-utilities>=0.14.3"
pip check
...
pip install "urllib3-future>=2.13.900"
...
pip check
pip install "intel-cmplr-lib-ur>=2025.2.0"
pip install "ipython>=9.3.0"
pip check
...
pip check
pip install "intel-openmp>=2025.2.0"
...
pip install "langsmith>=0.4.2"
pip install "llama-cloud>=0.1.26"
pip install "llama-index-instrumentation>=0.2.0"
pip install "llamaindex-py-client>=0.1.19"
pip check
pip install "mistralai>=1.8.2"
pip install "msal>=1.32.3"
pip check
pip install "ollama>=0.5.1"
pip install "openai>=1.92.2"
pip install "openmeteo-requests>=1.5.0"
pip install "opentelemetry-semantic-conventions>=0.55b1"
pip check
...
pip install "google-cloud-compute>=1.31.0"
...
pip install "llama-index-workflows>=1.0.1"
pip install "llm>=0.26"
pip check
pip install "mkl>=2025.2.0"
pip install "msal-extensions>=1.3.1"
pip check
pip install "nbformat>=5.10.4"
pip install "opentelemetry-instrumentation>=0.55b1"
...
pip check
pip install "google-cloud-bigquery>=3.34.0"
...
pip install "llama-index-core>=0.12.44"
pip install "llm-anthropic>=0.17"
pip install "llm-gemini>=0.23"
pip install "llm-ollama>=0.11"
pip check
pip install "nbclient>=0.10.2"
pip install "openinference-instrumentation>=0.1.34"
...
# Level 6
# Level 7
pip install "google-cloud-aiplatform>=1.99.0"
pip check
...
pip install "llama-index-readers-file>=0.4.9"
pip install "llm-claude-3>=0.11"
pip check
pip install "nbconvert>=7.16.6"
pip install "openinference-instrumentation-langchain>=0.1.43"
pip install "openinference-instrumentation-llama-index>=4.3.0"
pip install "openinference-instrumentation-openai>=0.1.30"
pip install "opentelemetry-instrumentation-fastapi>=0.55b1"
pip check
pip install "pandas-gbq>=0.29.1"
pip check
# Level 7
# Level 8
pip install "google-cloud-pipeline-components>=2.20.1"
pip check
pip install "jupyter-server>=2.16.0"
pip install "langchain-community>=0.3.26"
pip install "llama-index-agent-openai>=0.4.11"
pip install "llama-index-cli>=0.4.3"
pip install "llama-index-multi-modal-llms-openai>=0.5.1"
