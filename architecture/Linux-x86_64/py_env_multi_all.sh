...
pip check
pip install "google-cloud-bigquery>=3.36.0"
...
pip install "llm-ollama>=0.13.0"
pip check
pip install "nbclient>=0.10.2"
pip install "openinference-instrumentation>=0.1.37"
...
# Level 6
# Level 7
pip install "google-cloud-aiplatform>=1.110.0"
pip check
