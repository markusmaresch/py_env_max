...
pip install "google-genai>=1.37.0"
pip check
...
pip install "openmeteo-requests>=1.7.2"
...
pip install "openinference-instrumentation>=0.1.38"
...
# Level 6
# Level 7
pip install "google-cloud-aiplatform>=1.114.0"
pip check
...
pip install "openinference-instrumentation-openai>=0.1.32"
