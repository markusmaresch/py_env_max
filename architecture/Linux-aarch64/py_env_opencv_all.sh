# 2024-09-17T09:45:51.194798+00:00
# Level 1
...
pip check
pip install "fastjsonschema>=2.16.3"
...
pip install "jupyter-core>=5.1.5"
pip check
pip install "laspy>=2.4.1"
