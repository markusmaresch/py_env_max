...
pip install "scipy-stubs>=1.16.1.1"
pip check
pip install "tifffile>=2025.8.28"
...
pip install "grpcio-status>=1.74.0"
pip check
...
pip install "google-cloud-storage>=3.3.1"
pip check
# Level 6
