...
pip install "google-cloud-bigquery-storage>=2.27.0"
pip install "google-cloud-core>=2.4.1"
pip install "google-cloud-discoveryengine>=0.13.1"
pip install "google-cloud-documentai>=2.35.0"
pip install "google-cloud-language>=2.15.0"
pip install "google-cloud-monitoring>=2.23.0"
