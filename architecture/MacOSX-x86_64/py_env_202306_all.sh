...
pip install "astropy-iers-data>=0.2023.12.25.0.30.16"
...
pip install "pyinstaller-hooks-contrib>=2023.11"
...
pip install "jupyter-core>=5.6.0"
...
pip install "google-cloud-translate>=3.13.0"
