...
pip check
pip install "astropy-iers-data>=0.2024.2.19.0.28.47"
...
pip install "multimethod>=1.11.1"
...
pip install "hypothesis>=6.98.10"
pip check
...
pip install "pyinstaller-hooks-contrib>=2024.1"
